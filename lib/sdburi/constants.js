...
const getPlatformProtocolCommand = () => {
    let binPath = join(join(getPlatformHome(), getPlatformSdburiDir()), 'sdburi' + getPlatformExtension());
...
const constants = {
    ...
    sdburiPath: {
        ...
        path: join(join(getPlatformHome(), getPlatformSdburiDir()), 'sdburi' + getPlatformExtension()),
