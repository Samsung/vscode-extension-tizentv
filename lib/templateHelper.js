...
function _copyDirs(curDir, destDir) {
    logger.log('templateHelper: _copyDirs(${curDir},${destDir})');
...
function getDefualtName(tempName) {
    logger.log('templateHelper: getDefualtName(${tempName})');
...
function copyTemplate(tempName, prjPath) {
    logger.log('templateHelper: copyTemplate(${tempName})');
